...
class PatientRecipeTestPermissions(TestCase):
    def setUp(self):
        ...
        self.recipe_owner = PatientRecipeModel.objects.create(
    ...
    def test_is_superuser_or_admin_or_doctor_or_patient(self):
        perm = IsSuperUserAdminPharmacistOrPatient()
        ...
        self.assertTrue(perm.has_permission(req, None))
        self.assertTrue(perm.has_object_permission(req, None, self.recipe_owner))
