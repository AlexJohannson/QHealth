    ...
    return (
        <div className="admin-page-container">
            <div className="admin-page-information">
                ...
                <h3>This is the Admin dashboard of the clinic.</h3>
            </div>
            <div className={'clinic-photo-admin-page'}>
                <img src={'/img/photo-clinik.png'} alt="clinic-photo" className={'clinic-photo-admin'} />
            </div>
        </div>
    );
};
